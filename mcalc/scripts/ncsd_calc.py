...
def do_vce(a_outfile_map, a_values, a6_dir, heff_fname, a_prescription,
    ...
    fname = vce_int_fname % a_prescription
...
def ncsd_vce_calculation(a_prescription,
                         nshell=N_SHELL,
                         nhw=NHW, n1=N1, n2=N2,
                         path_results=PATH_RESULTS,
                         path_temp=PATH_TEMPLATES,
    ...
    :param dir_vce: Template string for the directory for the interactions
...
def ncsd_vce_calculations(a_prescriptions, **kwargs):
    for presc in a_prescriptions:
        ncsd_vce_calculation(a_prescription=presc,
                             **kwargs)


# SCRIPT
ncsd_vce_calculations(a_prescriptions=[(4, 5, 6), (6, 6, 6)], nhw=6,
                      force_vce=True)
